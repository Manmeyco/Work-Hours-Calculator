...
if(mon_total_sec > 28800):
    ...
    time.sleep(3) # Time delays to make it feel like it's calculating something, you can remove all "time.sleep" lines if you wish
...
time.sleep(3)
print() # blank line
print("Your hourly wage is $13 an hour. You can change this by opening this file in a text editor, such as Notepad or IDLE, and editing the hourly_wage variable.")
